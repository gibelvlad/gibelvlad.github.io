...
<body>
    <div class="container">
        ...
        <div class="event">
            <div class="event-title">Торжественная регистрация</div>
            <div class="event-time">09:40</div>
            <div class="event-location">Дворец бракосочетания</div>
            <div class="event-address">Пр. Ленина, 11 / ул. Гоголя, 46</div>
        </div>
        
        <div class="event">
            <div class="event-title">Банкет в честь свадьбы</div>
        ...
        <div class="rsvp-form">
            ...
            <p style="text-align: center; margin-bottom: 20px;">Пожалуйста, ответьте до 1 декабря 2025 года</p>
            ...
            <form id="rsvpForm" action="https://formspree.io/f/manlrqre" method="POST">
                ...
                <div class="form-group" id="companionField" style="display: none;">
    ...
    <script>
        // Простая логика для показа/скрытия поля спутника
        ...
        document.getElementById('rsvpForm').addEventListener('submit', function(e) {
            ...
            // Проверка наличия имени спутника если выбрано 2 человека
            const companions = document.getElementById('companions').value;
            const companionName = document.getElementById('companion_name').value;
            
            if (companions === '2' && !companionName.trim()) {
                alert('Пожалуйста, укажите имя и фамилию вашего спутника');
                return;
            }
            
            // Показ сообщения об успехе
            alert('Спасибо за ваш ответ! Мы очень рады!');
